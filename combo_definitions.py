...
COMBO_DEFINITIONS: dict[str, dict[str, Any]] = {
    "combo_u45_u105": {
        ...
        # Filtros mais abertos — 0 apostas com thresholds altos.
        "min_volume": 400,
        "min_volume_leg2": 150,
        "min_combined_odds": 1.45,
...
# Relaxamento para semi/manual (sugestões) — auto já usa defaults mais abertos.
